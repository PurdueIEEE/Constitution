...
\begin{itemize}
    ...
    \item EMBS Industrial Liaison \todo[backgroundcolor=red!25]{MRH: The order here is not matched in the following paragraphs.}
...
The EMBS Student Liaison will create plans for extended learning opportunities for EMBS members that explore topics in depth or impart valuable skills to those in attendance. \todo[backgroundcolor=red!25]{MRH: The liaisons do not match the Cornerstones committees they work with.}
