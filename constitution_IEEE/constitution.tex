...
\begin{itemize}
    ...
    \item Powers specific to each office are outlined in Article V. The passage of amendments in Article VII, the collection of dues in Article VIII, and the responsibility of organizing committees in Article IX, Article X, and Article XI are detailed in the mentioned articles.
\end{itemize}
...
\begin{itemize}
    ...
    \item Technical committees and event committees must specify their procedure for filling chair vacancies in their respective technical committee bylaws or event committee bylaws. In the event a committee vacancy is not resolved within ten days, the President may nominate a replacement subject to an ECMV.
...
\begin{itemize}
    \item Ad hoc committees may be formed or appointed by any elected officer to assist and fulfil within his or her constitutional duties.
    \begin{itemize}
    ...
    \item Ad hoc committees are meant for the delegation of duties that might otherwise be too demanding of an elected officer’s time.
    \end{itemize}
	...
	\item The chair of a committee cannot be an elected officer.
    \end{itemize}
...
\begin{itemize}
    ...
    \item Will contact and interact with alumni.
    ...
    \begin{itemize}
    \item Interact with the community especially grade school and high school students to encourage them to pursue STEM and IEEE.
    \item Organize outreach events with IEEE section and region members.
	\end{itemize}    
    \item Must maintain a contact list of all alumni.
...
\label{sec:inclusion}
\begin{itemize}
\item Event committees must operated under the name of Purdue IEEE Student Branch for all events.
\item No event committee chair may include the word “President” in his or her internal title.
\item Joint projects should be formalized in a project charter as detailed in Article X, Section 6.
\end{itemize}
...
\begin{itemize}
    ...
    \item Reasons for losing good standing include but are not limited to: closing operations from the view of elected officers, willful disregard of the Constitution, continued bankruptcy of event committee funds, or failure to follow established event committee bylaws.
